...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=arcgis-demographic-clustering
SET SUPPORT_LIBRARY = arcgis_clustering
SET ENV_NAME=arcgis-clustering
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/arcgis-demographic-clustering*.tar.bz2
